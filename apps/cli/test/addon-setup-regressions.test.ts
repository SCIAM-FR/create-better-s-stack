...
describe("Addon setup regressions", () => {
  it("uses a package execution command for the Better S Stack MCP server target", () => {
    ...
    expect(betterTStackServer?.target).toBe("bunx @sciam-fr/create-better-s-stack@latest mcp");
  });
