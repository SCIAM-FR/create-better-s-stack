...
create-better-s-stack --database mongodb --orm drizzle

# ✅ Valid - MongoDB with Mongoose
create-better-s-stack --database mongodb --orm mongoose
```
...
create-better-s-stack --runtime workers --backend express

# ✅ Valid - Workers with Hono
create-better-s-stack --runtime workers --backend hono --database sqlite --orm drizzle --db-setup d1

# ✅ Also valid - Workers with Prisma (D1)
create-better-s-stack --runtime workers --backend hono --database sqlite --orm prisma --db-setup d1
```
...
create-better-s-stack --frontend nuxt --api trpc

# ✅ Valid - Nuxt with oRPC
create-better-s-stack --frontend nuxt --api orpc
```
...
create-better-s-stack --frontend next tanstack-router
...
create-better-s-stack --auth better-auth --database none

# ✅ Valid - Better-Auth with full stack
create-better-s-stack --auth better-auth --database postgres --orm drizzle --backend hono

# ✅ Valid - Clerk with Hono
create-better-s-stack --auth clerk --backend hono --frontend tanstack-router

# ✅ Valid - Clerk with fullstack Next.js
create-better-s-stack --auth clerk --backend self --frontend next

# ❌ Invalid - Clerk with Astro
create-better-s-stack --auth clerk --backend self --frontend astro
```
...
```bash
# Fix by using Hono
create-better-s-stack --runtime workers --backend hono
```
