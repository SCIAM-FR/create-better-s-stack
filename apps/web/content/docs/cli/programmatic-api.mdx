...
description: Use Better-S-Stack programmatically in your Node.js applications
---

## Overview

You can call Better-S-Stack directly from TypeScript/JavaScript without shelling out to the CLI.

The programmatic API is exported from `create-better-s-stack` and is designed for automation tools, internal generators, and scripted workflows.
...
```npm
npm i @sciam-fr/create-better-s-stack
```
...
Add addons to an existing Better-S-Stack project.
...
```typescript
import { createVirtual } from "@sciam-fr/create-better-s-stack";
