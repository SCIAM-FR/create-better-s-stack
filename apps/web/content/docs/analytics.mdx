...
```bash
BTS_TELEMETRY_DISABLED=1 npx @sciam-fr/create-better-s-stack@latest
```
...
- CLI event sender: [`apps/cli/src/utils/analytics.ts`](https://github.com/SCIAM-FR/create-better-s-stack/blob/main/apps/cli/src/utils/analytics.ts)
- Telemetry toggle logic: [`apps/cli/src/utils/telemetry.ts`](https://github.com/SCIAM-FR/create-better-s-stack/blob/main/apps/cli/src/utils/telemetry.ts)
- Ingest endpoint: [`packages/backend/convex/http.ts`](https://github.com/SCIAM-FR/create-better-s-stack/blob/main/packages/backend/convex/http.ts)
- Analytics backend (ingest + aggregation): [`packages/backend/convex/analytics.ts`](https://github.com/SCIAM-FR/create-better-s-stack/blob/main/packages/backend/convex/analytics.ts)
