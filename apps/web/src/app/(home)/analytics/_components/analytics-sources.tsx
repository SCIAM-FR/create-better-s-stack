  ...
  return (
    <div className="rounded border border-border bg-fd-background p-4">
      ...
      <div className="mt-4 space-y-3 text-sm">
        <Link
          href="https://github.com/SCIAM-FR/create-better-s-stack/blob/main/apps/cli/src/utils/analytics.ts"
          target="_blank"
        ...
        <Link
          href="https://github.com/SCIAM-FR/create-better-s-stack/blob/main/packages/backend/convex/analytics.ts"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center justify-between rounded border border-border px-3 py-2.5 transition-colors hover:border-muted-foreground/30"
        >
